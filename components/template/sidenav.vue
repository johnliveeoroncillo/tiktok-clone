    ...
    <div class="relative w-[100px] border-r lg:border-0 lg:w-[25%] h-full">
        <perfect-scrollbar class="flex flex-col py-7 gap-5 w-full px-5 lg:pl-0">
            <div class="flex flex-col gap-4">
                <nuxt-link to="/" class="flex flex-row justify-center lg:justify-start gap-0 lg:gap-2 text-lg font-bold tracking-wide items-center text-primary">
                ...
                <nuxt-link to="/" class="flex flex-row justify-center lg:justify-start gap-0 lg:gap-2 text-lg font-bold tracking-wide items-center">
