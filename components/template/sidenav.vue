<template>
    <div class="relative w-[35%]">
        <div class="absolute flex flex-col py-7 gap-5 overflow-auto w-full h-full pr-4">
            <div class="flex flex-col gap-4">
                <nuxt-link to="/" class="flex flex-row gap-2 text-lg font-bold tracking-wide items-center text-primary">
                ...
                <nuxt-link to="/" class="flex flex-row gap-2 text-lg font-bold tracking-wide items-center">
            ...
            <span class="text-black opacity-50 font-thin">Log in to follow creators, like videos, and view comments.</span>
            <button class="border border-primary rounded text-white py-3 font-bold hover:bg-pink-100 text-primary">
                Log In
            </button>
            ...
            <div class="flex flex-col gap-4">
                <span class="text-sm font-semibold text-gray-500 tracking-wide">Suggested accounts</span>
                <div class="flex flex-col gap-4 w-full">
                    <div class="flex flex-row gap-4" v-for="d in 20" :key="d">
                        ...
                        <div>
                            <span class="font-black tracking-wider flex text-sm flex-row items-center justify-between gap-1 block">
                                nianaguerrero
                    ...
                    <nuxt-link to="/" class="text-primary font-semibold text-sm tracking-wider">See all</nuxt-link>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-row gap-2 w-full flex-wrap">
                    <div class="rounded-full border border-gray-300 text-sm text-gray-500 tracking-tight py-1 px-4 flex flex-row gap-2 items-center">
